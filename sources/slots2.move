...
/// A "sub-bet" takes the form of a line (vector<u64>) a vector of symbols (vector<u64>) and a multiplier (u64).
...
/// to exist in sequence as a subset of the vector represented by the line in the result. Such a bet is divided into many
/// unit-bets. The EV of a sub-bet is the sum of the EVs of the unit-bets it is divided into.
